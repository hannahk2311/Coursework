...
{
    public partial class randomisedRadioButtonsEasy : Form
    {
        //declare any classes
        Player thisPlayer;
        ...
        public randomisedRadioButtonsEasy(Player ThisPlayer)
        {
            InitializeComponent();
            //Parameter passing
        ...
        private void randomisedRadioButtonsEasy_Load(object sender, EventArgs e)
        {
            try
            {
                int arrayLength = 0;
                string file_name = //(Environment.GetFolderPath(Environment.SpecialFolder.MyComputer) + "/rdbQuestionsEasy.txt");
                    "F:\\Computing\\28-01-18 SSDCoursework\\SSDCoursework\\rdbQuestionsEasy.txt";
        ...
        {
            Form hardRadioButtonsHelp = new hardRadioButtonsHelp();
            hardRadioButtonsHelp.Show();
        }
    }
}
